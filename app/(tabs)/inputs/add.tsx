...
export default function RegisterInputScreen() {
  const colorScheme = useColorScheme();
  const themeColors = Colors[colorScheme];
  ...
  const handleRegister = () => {
    console.log('Registrar Insumo:', inputName);
    router.back();
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Controle de Cadastros de Insumos
        </Text>
        ...
        >
          ...
          >
            ...
            <LabelledInput label="UNIDADE" required />
